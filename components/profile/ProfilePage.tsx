            ...
            <section className="flexBetween max-lg:flex-col gap-y-10 w-full">
                <div>
                    <Image
                        ...
                        alt="user image"
                    />
                    <p className="text-[25px] leading-[32px] font-bold mt-[40px]">
                        {user?.name}
                    </p>
                    <p className="md:text-[37px] text-[25px] md:leading-[61px] leading-[32px] font-extrabold md:mt-[40px] mt-5 lg:max-w-[444px]">
                         Student from VISHNU INSTITUTE OF TECHNOLOGY 👋
                    </p>
                ...
                {user?.projects?.edges?.length > 0 ? (
                    <Image
                        // @ts-ignore
                        src={user?.projects?.edges[5]?.node?.image}
                        width={739}
                        height={554}
                        alt="project image"
